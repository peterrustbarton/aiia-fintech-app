                ...
                <CardContent>
                    <div className="rounded-md border">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    <TableHead>Symbol <SortIcon field="symbol" /></TableHead>
                                    <TableHead>Company <SortIcon field="company_name" /></TableHead>
                                    <TableHead>Sector <SortIcon field="sector" /></TableHead>
                                    <TableHead>Market Cap <SortIcon field="market_cap" /></TableHead>
                                    <TableHead>Live Price <SortIcon field="live_price" /></TableHead>
                                    <TableHead>Change % <SortIcon field="price_change" /></TableHead>
                                    <TableHead>AI Score <SortIcon field="score" /></TableHead>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={cn(
                                                        "font-bold text-lg",
                                                        getChangeColor(security.price_change_percent)
                                                    )}
                                                >
                                                    {formatChange(security.price_change_percent)}
                                                </span>
                                                {security.price_change_percent != null && (
                                                    <>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={cn(
                                                        "font-bold text-lg",
                                                        getScoreColor(
                                                            security.latest_score?.score_value
                                                        )
                                                    )}
                                                >
                                                    {security.latest_score?.score_value
